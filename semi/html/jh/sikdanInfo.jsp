	...
	<div id="main">
		...
		<div id="site_content">
			...
			<!-- Banner -->
				...
				<!-- Section -->
				<section>
					<img src="/semi/source/image/chiken.png" width="200" height="200"> <br>
					...
					<p>
						...
						있습니다. <br>
						<br> <b>네번째,</b> 성인병 예방 닭가슴살 속에는 불포화지방산 필수지방산이 풍부해서 고혈압이나 심장병
						등과 같은 성인질병에 대해 예방 할 수 있는 음식 중 하나라고 하는데요, 부담없는 칼로리에 즐겨드시게 되더라도 성인병을
						예방하고 살도 안찌니 참 고마운 음식이지요!!!
					</p>
				</section>

				<!-- Section -->
				<section>
					<img src="/semi/source/image/onions.jpg" width="200" height="200"> <br>
					...
					<p>
						...
						예방하는데 좋은 음식입니다. 양파의 알리신 성분이 몸속의 나쁜 세포들을 제거하는 효과가 있습니다. <br>
						<br> <b>세번째,</b> 노화 예방 및 피부 미용 양파의 항산화 물질인 퀴르세틴 성분과 플로보노이드
						성분이 풍부하여 노화를 예방하고 혈액을 깨끗하게 유지시켜줍니다.
					</p>
				</section>

				<section>
					<img src="/semi/source/image/dotori1.jpg" width="200" height="200"> <img
						src="/semi/source/image/dotori2.jpg" width="200" height="200"> <br>
					영양가 만점! 매력적인 그 맛 <b>도토리!</b> <br>
					<br> <b>첫번째,</b> 아콘산(Acomicacid)이란​ 성분이 풍부하여 중금속과 여러 유해물질을 체외로
					배출하는 효과가 있습니다. <br>
					<br> <b>두번째,</b> 떫은 맛을 내는 타닌 성분은 지방의 흡수를 막아주고, 100그램당 45kcal의
					저열량이므로 다이어트음식으로 좋답니다. <br>
					<br> <b>세번째,</b> 설사와 이질을 치료하고 장과 위를 튼튼하게 하며 들깨와 같이 먹으면 좋은 궁합을
					이루어 콜레스테롤 수치를 낮추어 고혈압, 동맥경화, 당뇨병 등 성인​병을 예방하는 효능을 발휘합니다. <br>
					<br> <b>네번째,</b> ​동의보감에 의하면 늘 배가 부르고 끓는 사람, 변이 불규칙적인 사람, ​몸이
					붓거나 소변을 자주 보는 사람에게 좋다고 합니다. <br>
					<br> <b>다섯번째,</b> 피로회복, 숙취해소에 탁월한​ 효능이 있으며 입안이 헐고 잇몸에서 피가
					​날때에도 좋습니다. <br>
					<br> <b>여섯번째,</b> 타닌 성분은 모세혈관을 튼튼하게 하는 효능이 있으나 과다 섭취를 하면 변비가
					되므로 유의해야 한답니다.
				</section>
			</div>
			<!--내용끝-->
